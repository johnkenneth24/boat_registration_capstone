                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_id"
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}"@selected($borrower->user_id == $user->id)>
                                                        {{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('user_id')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="book_id"
                                                ...
                                                @foreach ($books as $book)
                                                    <option value="{{ $book->id }}"@selected($borrower->book_id == $book->id)>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="quantity"
                                                ...
                                                placeholder="Enter quantity" value="{{ $borrower->quantity }}" required>
                                            @error('quantity')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="borrowed_at"
                                                ...
                                                value="{{ $borrower->borrowed_at->format('Y-m-d') }}" required>
                                            @error('borrowed_at')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
