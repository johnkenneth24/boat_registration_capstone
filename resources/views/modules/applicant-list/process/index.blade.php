                    ...
                    <div class="card mt-5">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Boat Registration Information</h4>
                            </div>
                            <div class="card-tools">
                                <a href="{{ route('applist.index') }}" class="btn btn-danger">Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group col-md-12">
                                <label for="">Serial Number</label>
                                <input type="text" name="" id="" class="form-control" placeholder="Enter Serial No.">
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="" id="" class="form-control" placeholder="Enter Registered Breadth">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="">Registered Depth</label>
                                <input type="text" name="" id="" class="form-control" placeholder="Enter Register Depth">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <button type="submit" class="btn btn-success mr-2">Submit</button>
                            <a href="{{ route('applist.mfr-form') }}" class="btn btn-primary">Next - MFR Form</a>
                        </div>
                    </div>
                </div>
            </div>
