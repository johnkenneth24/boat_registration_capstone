                ...
                <div class="col-md-12">
                    <div class="card card-outline card-warning mt-5">
                            ...
                            <div class="row border border-secondary">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        @isset($boatReg->registration_no)
                                            <input type="text" name="registration_no" class="form-control"
                                                value="{{ $boatReg->registration_no }}" readonly>
                                        @endisset
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="month" name="year_built" readonly max="{{ date('Y-m') }}"
                                                    class="form-control form-control-sm"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            <input type="number" min="1" step="0.01"
                                                                ...
                                                                value="{{ $boatReg->boat->horsepower }}" placeholder="0">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <form method="post"
                                            action="{{ route('reg-boat.update-pending', $boatReg->boat->id) }}"
                                            autocomplete="off">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="number" min="0" step="0.01" name="breadth"
                                                        ...
                                                        placeholder="Registered Breadth of the Vessel  (in meters)"
                                                        required>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" min="0" step="0.01"
                                                        name="net_tonnage" required
                                                        value="{{ $boatReg->boat->net_tonnage }}"
                                                        class="form-control form-control-sm">
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="form-group">
                                            <label>Image of the Boat</label> <br>
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <a href="{{ route('reg-boat.pending') }}" class="btn btn-primary col-md-2 mr-2">
