                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                <input type="number" min="1" step="0.01"
                                                                    ...
                                                                    value="{{ $walkin->horsepower }}" placeholder="0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01" name="length"
                                                    ...
                                                    value="{{ $walkin->length }}" placeholder="(in meters)" required>
                                                @error('length')
                                                    <div class="invalid-feedback" style="display: inline-block !important;">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01" name="breadth"
                                                    ...
                                                    value="{{ $walkin->breadth }}" placeholder="(in meters)" required>
                                                @error('breadth')
                                                    <div class="invalid-feedback" style="display: inline-block !important;">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01" name="depth"
                                                    ...
                                                    value="{{ $walkin->depth }}" placeholder="(in meters)" required>
                                                @error('depth')
                                                    <div class="invalid-feedback" style="display: inline-block !important;">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01"
                                                    ...
                                                    value="{{ $walkin->tonnage_length }}" placeholder="(in meters)"
                                                    required>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01"
                                                    ...
                                                    value="{{ $walkin->tonnage_breadth }}" placeholder="(in meters)"
                                                    required>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" min="0" step="0.01" name="tonnage_depth"
                                                    ...
                                                    value="{{ $walkin->tonnage_depth }}" placeholder="(in meters)"
                                                    required>
                                                @error('tonnage_depth')
                                                    <div class="invalid-feedback" style="display: inline-block !important;">
                                                        {{ $message }}
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="0" step="0.01" name="gross_tonnage"
                                                    required value="{{ $walkin->gross_tonnage }}" required
